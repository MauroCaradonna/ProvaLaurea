...
public class Simulator {
		...
		/*private Model model;
		private Map<String, CostVarianceData> cvdByItemMap;*/
//		private String eventString;
		...
		// Parametri di input
		private List<SimulatorItem> actualWarehouse; //= new ArrayList<SimulatorItem>();
		private Map<String, Integer> bom;// = new HashMap<String, Integer>();
		
		
		private Period DURATION_FINDING =Period.ofDays(3);
		private Period DURATION_LEAD_TIME = Period.ofDays(42);
		...
		public void init(List<SimulatorItem> actualInput, Map<String, Integer> bomInput, LocalDate startDateInput,
				Map<String, Probability> probabilitiesInput, Map<String, List<PriceTrend>> trendsByItemInput) {
//			this.eventString ="";
			this.simulatorRowList = new LinkedList<SimulatorRow>();
			
			/*this.model = new Model();
			this.cvdByItemMap = new HashMap<String, CostVarianceData>();
...
//					this.eventList.add(e);
		...
		public void setDURATION_LEAD_TIME(Period dURATION_LEAD_TIME) {
			DURATION_LEAD_TIME = dURATION_LEAD_TIME;
		}
